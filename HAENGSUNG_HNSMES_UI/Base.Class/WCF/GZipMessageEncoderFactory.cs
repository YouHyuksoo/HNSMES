...
namespace IDAT.GZipEncoder
{
    ...
    {
        //XmlDictionaryReaderQuotas xmlReaderQuot = new XmlDictionaryReaderQuotas();
        ...
        class GZipMessageEncoder : MessageEncoder
        {
            ...
            public override System.ServiceModel.Channels.Message ReadMessage(ArraySegment<byte> buffer, BufferManager bufferManager, string contentType)
            {
                ...
                System.ServiceModel.Channels.Message returnMessage = innerEncoder.ReadMessage(decompressedBuffer, bufferManager);
