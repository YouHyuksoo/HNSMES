...
namespace HAENGSUNG_HNSMES_UI.Class
{
    public class WorkPlan
    {
        ...
        private DataTable SetWorkPlanTable()
        {
            DataTable _dt = new DataTable();

            _dt.Columns.Add("PRODLINE", Type.GetType("System.String"));
        ...
        private DataTable SetWorkPlanTimeTable()
        {
            DataTable _dt = new DataTable();
        ...
        public DataSet GetWorkPlan(string _File)
        {
            ...
            DataTable _dt1 = SetWorkPlanTable();
            DataTable _dt2 = SetWorkPlanTimeTable();
