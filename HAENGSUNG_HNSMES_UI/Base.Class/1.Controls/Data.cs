...
namespace DevExpress.RealtorWorld.Win {
    ...
    public class Home {
        ...
        public string Type { get { return DevExpress.Data.Mask.EnumHelper.GetEnumItemDisplayText((PropertyType)row["Type"]); } }
        public string Status { get { return DevExpress.Data.Mask.EnumHelper.GetEnumItemDisplayText((PropertyStatus)row["Status"]); } }
