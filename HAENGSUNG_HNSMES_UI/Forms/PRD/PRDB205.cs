...
namespace HAENGSUNG_HNSMES_UI.Forms.PRD
{
    ...
    ///</summary>
    ///
    public partial class PRDB205 : HAENGSUNG_HNSMES_UI.Forms.BASE.Form, HAENGSUNG_HNSMES_UI.Class.itfButton
    {
        // ******************************************* Base From Class ************************************
        ...
        private void PRDB205_Load(object sender, EventArgs e)
        {
            this.Set_Init();            
        }

        private void PRDB205_Shown(object sender, EventArgs e)
        {
