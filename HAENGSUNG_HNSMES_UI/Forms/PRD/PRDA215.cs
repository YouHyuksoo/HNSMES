...
namespace HAENGSUNG_HNSMES_UI.Forms.PRD
{
    ...
    public partial class PRDA215 : HAENGSUNG_HNSMES_UI.Forms.BASE.Form, HAENGSUNG_HNSMES_UI.Class.itfButton, HAENGSUNG_HNSMES_UI.Class.itfScanner
    {
        // ******************************************* Base From Class ************************************
        ...
        private void PRDA215_Load(object sender, EventArgs e)
        {

        }

        private void PRDA215_Shown(object sender, EventArgs e)
        {
            // ************************************************************************************
        ...
        private void SetButton(object sender,  EventArgs e)
        {
            ...
            if (btn.Name != "btnProdReady")
            {
                ...
                if (_drWorkord[0]["PARTNO"].ObjectNullString() != glePartNo.Text)
                {
