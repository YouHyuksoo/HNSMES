...
namespace HAENGSUNG_HNSMES_UI.Forms.PRD.PopUp
{
    ...
    public partial class POP_PRD06 : HAENGSUNG_HNSMES_UI.Forms.BASE.Form
    {
        ...
        private void POP_PRD06_Load(object sender, EventArgs e)
        {
            InitForm();
        }

        private void POP_PRD06_Shown(object sender, EventArgs e)
        {
        ...
        {
            if(gleModel.EditValue == null)
            {
                gleSide.Properties.DataSource = null;
            }
            else
            {
                speArray.EditValue = gleModel.Properties.View.GetRowCellValue(gleModel.Properties.View.FocusedRowHandle, "ARRAYQTY");
                string sProductionType = gleModel.Properties.View.GetRowCellValue(gleModel.Properties.View.FocusedRowHandle, "PRODUCTIONTYPE").ToString();
                GetSide(sProductionType);
            }
        }

        private void gleLine_EditValueChanged(object sender, EventArgs e)
        {
            if (gleLine.EditValue != null)
                GetModel(gleLine.EditValue.ToString());
            else
                gleModel.Properties.DataSource = null;
        ...
        private void GetModel(string sLine)
        {
            BASE_DXGridLookUpHelper.Bind_GridLookUpEdit(gleModel,
                                                        "PKGPRD_SMT.GET_MODEL",
                                                        2,
                                                        new string[] { "A_LINE" },
                                                        new string[] { sLine },
                                                        "ITEMCODE",
        ...
        private bool InputChk(bool bSave)
        {
            ...
            {
                iDATMessageBox.ErrorMessage("MSG_ER_WO_013", this.Text, 3);
                speOrdQty.Focus();
                return false;
            }
