...
namespace HAENGSUNG_HNSMES_UI.Forms.PRD
{
    ...
    public partial class PRDA212 : HAENGSUNG_HNSMES_UI.Forms.BASE.Form, HAENGSUNG_HNSMES_UI.Class.itfButton, HAENGSUNG_HNSMES_UI.Class.itfScanner
    {
        // ******************************************* Base From Class ************************************
        ...
        private void PRDA212_Load(object sender, EventArgs e)
        {

        }

        private void PRDA212_Shown(object sender, EventArgs e)
        {
            // ************************************************************************************
        ...
        private void GetGridViewList()
        {
            BASE_DXGridHelper.Bind_Grid_Int( gcList
                                           , "PKGPRD_CURRENT.GET_PROD_WRKORD_HISTORY"
                                           , 1
                                           , new string[] { 
                                             "A_CLIENT"
                                           , "A_COMPANY"
                                           ...
                                           , Global.Global_Variable.COMPANY
                                           , Global.Global_Variable.PLANT
                                           , gleWorkorder.EditValue.ObjectNullString() }
                                           , true
                                           , ""
                                           , false//true
                                           , ""
        ...
        private void GetWorkorder(string _strWorkorder)
        {
            /*작업지시 정보*/
            BASE_DXGridLookUpHelper.Bind_GridLookUpEdit( gleWorkorder
                                                       , "GPKGPRD_PROD.GET_MAINASSY_WORKORD"
                                                       , 1
                                                       , new string[] {
                                                         "A_CLIENT"
                                                       , "A_COMPANY"
            ...
            gleWorkorder.EditValue = _strWorkorder;
        }
        private void SetButton(object sender,  EventArgs e)
        {
            ...
            {
                if (gleWorkorder.EditValue.ObjectNullString() == "")
                {
                ...
                if (!_drWorkord[0]["PARTNO"].ObjectNullString().Contains(glePartNo.SelectedText))
                {
                ...
                gleWorkorder.Properties.ReadOnly = true;
            ...
            else
            {
                ...
                gleWorkorder.Properties.ReadOnly = false;
        ...
        private int SET_PROD_PRODUCTION(string p_strJudge, string p_strDefect, string p_strDefect1, string p_strDefect2)
        {
            ...
            if (_Result.ResultInt == 0)
            {
                ...
                else
                {
                    ...
                    Print4(_Result.ResultDataSet.Tables[2]
                          , _defect
                          , _defect1
                          , _defect2
                          , 1); //NG
        ...
        {
            if (Global.Global_Variable.USER_ID == "SYSOPER")
                Get_BarcodeType("WO20190624P0002");//ProcessScanEvent("NODEFINE", "OK");
        }
    }
}