...
namespace HAENGSUNG_HNSMES_UI.Forms.PRD
{
    ...
    ///==========================================================
    ///</summary>
    public partial class PRDA221 : HAENGSUNG_HNSMES_UI.Forms.BASE.Form, HAENGSUNG_HNSMES_UI.Class.itfButton, HAENGSUNG_HNSMES_UI.Class.itfScanner
    {
        ...
        private void PRDA221_Load(object sender, EventArgs e)
        {

        }

        private void PRDA221_Shown(object sender, EventArgs e)
        {
            InitForm();
        }
