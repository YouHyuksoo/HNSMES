...
namespace HAENGSUNG_HNSMES_UI.Forms.SAL
{
    ...
    public partial class SALB202 : HAENGSUNG_HNSMES_UI.Forms.BASE.Form, HAENGSUNG_HNSMES_UI.Class.itfButton
    {
        // ******************************************* Base From Class ************************************
        ...
        private void SALB202_Load(object sender, EventArgs e)
        {
            Set_Init();
            toolTipController1.Active = true;
        }

        private void SALB202_Shown(object sender, EventArgs e)
        {
        ...
        private void GetGridViewList()
        {
            if (tabbedControlGroup2.SelectedTabPageIndex == 0)
            {
                BASE_DXGridHelper.Bind_Grid( gcList1
                                           , "PKGPRD_REPORT.GET_PRODUCT_STOCK_A"
                                           , 1
                                           , new string[] {
                                             "A_CLIENT"
                                           , "A_COMPANY"
            ...
            else
            {
                BASE_DXGridHelper.Bind_Grid( gcList3
                                           , "PKGPRD_REPORT.GET_PRODUCT_STOCK_B"
                                           , 1
                                           , new string[] {
                                             "A_CLIENT"
                                           , "A_COMPANY"
