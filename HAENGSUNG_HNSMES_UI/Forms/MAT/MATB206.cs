...
namespace HAENGSUNG_HNSMES_UI.Forms.MAT
{
    ...
    public partial class MATB206 : HAENGSUNG_HNSMES_UI.Forms.BASE.Form, HAENGSUNG_HNSMES_UI.Class.itfButton
    {
        // ******************************************* Base From Class ************************************
        ...
        private void MATB206_Load(object sender, EventArgs e)
        {
            Set_Init();
            toolTipController1.Active = true;
        }

        private void MATB206_Shown(object sender, EventArgs e)
        {
        ...
        private void Set_Init()
        {
            ...
            if ((gleWH.Properties.DataSource as DataTable).Rows.Count > 1)
            {
        ...
        private void InCompany_GetGridViewList()
        {
            if (tabbedControlGroup2.SelectedTabPageIndex == 0)
            {
                BASE_DXGridHelper.Bind_Grid( gcList1
                                           , "PKGBAS_MAT.GET_MATERIAL_STOCK_INCOMPANY_A"
                                           , 1
                                           , new string[] {
                                             "A_CLIENT"
                                           , "A_COMPANY"
            ...
            else
            {
                BASE_DXGridHelper.Bind_Grid( gcList3
                                           , "PKGBAS_MAT.GET_MATERIAL_STOCK_INCOMPANY_B"
                                           , 1
                                           , new string[] {
                                             "A_CLIENT"
                                           , "A_COMPANY"
