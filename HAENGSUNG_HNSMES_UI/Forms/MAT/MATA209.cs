...
{    
    public partial class MATA209 : HAENGSUNG_HNSMES_UI.Forms.BASE.Form, HAENGSUNG_HNSMES_UI.Class.itfButton, HAENGSUNG_HNSMES_UI.Class.itfScanner
    {
        // ******************************************* Base From Class ************************************
        ...
        public void SearchButton_Click()
        {
            ...
            _strPartNo = txtSearchPartNo.EditValue.ObjectNullString();
            _strSN = txtSearchSN.EditValue.ObjectNullString();
        ...
        public void SaveButton_Click()
        {
            ...
            bool bRtn = BASE_db.Execute_Proc( "PKGPDA_MAT.SET_RELEASE"
                                            , 1
                                            , new string[] {
                                              "A_CLIENT"
                                            , "A_COMPANY"
                                            ...
                                            , dteOut.DateTime.ToString("yyyyMMdd")
                                            , _strXML
                                            , memRemarks.Text
