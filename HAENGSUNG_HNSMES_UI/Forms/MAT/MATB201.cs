...
namespace HAENGSUNG_HNSMES_UI.Forms.MAT
{
    ...
    ///==========================================================<br/>
    ///    화면명 : MATAB206<br/>
    ///      기능 : 자재입고, 자재출고, 자재입/출고, Split/Merge이력, 제품 입/출고 <br/>
    ///      작성 : 행성사 정보전략팀<br/>
    ///최초작성일 : 2018-04-01<br/>
    ///  수정사항 : 최초작성<br/>
    ///==========================================================
    ...
    public partial class MATB201 : HAENGSUNG_HNSMES_UI.Forms.BASE.Form, HAENGSUNG_HNSMES_UI.Class.itfButton, HAENGSUNG_HNSMES_UI.Class.itfScanner
    {
        // ******************************************* Base From Class ************************************
        ...
        private void MATB201_Load(object sender, EventArgs e)
        {

        }

        private void MATB201_Shown(object sender, EventArgs e)
        {
            Set_Init();
        }
        ...
        private void ProcessScanEvent(string p_strType, string p_strData)
        {
            ...
            {
                case "MATSN":
                    txtSN.EditValue = p_strData;
                    break;

                case "PARTNO":
                    txtPartNo.EditValue = p_strData;
                    break;
        ...
        private void RELEASE_GetGridViewList()
        {
            BASE_DXGridHelper.Bind_Grid( gcList1
                                       ...
                                       , gleWHLoc.EditValue.ObjectNullString() }
                                       , true
                                       , "TOVENDOR, FROMVENDOR, UNDOFLAG, TXNTIMEKEY, TXNCODE"
                                       , false
                                       );
        ...
        {
            if (this.Tag.ObjectNullString() != "OUTSOURCING")
            {
                if (this.Tag.ObjectNullString() == "PRODIN")
                    _strWarehouse = "3";
                else
                    _strWarehouse = "4";
