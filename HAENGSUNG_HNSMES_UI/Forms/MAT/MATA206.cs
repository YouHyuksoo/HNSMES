...
namespace HAENGSUNG_HNSMES_UI.Forms.MAT
{
    ...
    ///</summary>
    ///
    public partial class MATA206 : HAENGSUNG_HNSMES_UI.Forms.BASE.Form, HAENGSUNG_HNSMES_UI.Class.itfButton, HAENGSUNG_HNSMES_UI.Class.itfScanner
    {
        // ******************************************* Base From Class ************************************
        ...
        private void GetGridViewList(string p_strWH, string p_strWHLoc, string p_strPartNo, string p_strSN)
        {
            ...
            BASE_DXGridHelper.Bind_Grid_Int( gcList
                                           , "PKGBAS_MAT.GET_WAREHOUSE_NONE_STOCK"
                                           , 1
                                           , new string[] {
                                             "A_CLIENT"
                                           , "A_COMPANY"
