...
namespace HAENGSUNG_HNSMES_UI.Forms.MAT
{
    ...
    public partial class MATB204 : HAENGSUNG_HNSMES_UI.Forms.BASE.Form, HAENGSUNG_HNSMES_UI.Class.itfButton, HAENGSUNG_HNSMES_UI.Class.itfScanner
    {
        #region [Form Event]
        ...
        private void MATB204_Load(object sender, EventArgs e)
        {

        }

        private void MATB204_Shown(object sender, EventArgs e)
        {
            this.Set_Init();
        }
        ...
        {
            if (this.Tag.ObjectNullString() == "PRODINOUT")
                _strWarehouse = "3";
            else
                _strWarehouse = "4";
