...
namespace HAENGSUNG_HNSMES_UI.Forms.MAT
{
    ...
    public partial class MATB203 : HAENGSUNG_HNSMES_UI.Forms.BASE.Form, HAENGSUNG_HNSMES_UI.Class.itfButton, HAENGSUNG_HNSMES_UI.Class.itfScanner
    {
        #region [Form Event]
        ...
        private void MATB203_Load(object sender, EventArgs e)
        {
            switch (this.Tag + "")
            {
                case "RECEIVE":
        ...
        private void MATB203_Shown(object sender, EventArgs e)
        {
            this.Set_Init();
        }
        ...
        private void rdgInOut_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if (rdgInOut.EditValue.ObjectNullString() == "SPLITMERGE")
            {
                this.Set_gleType("SPLITMERGE");
                this.Tag = "SPLITMERGE";
            }
            else
            {
