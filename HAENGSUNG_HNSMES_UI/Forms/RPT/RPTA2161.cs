...
{
    public partial class RPTA2161 : DevExpress.XtraReports.UI.XtraReport
    {
        int mnCopies;
        ...
        public RPTA2161(DataTable dTable, int nCopies)
            : this()
        {
            for (int nRow = 0; nRow < dTable.Rows.Count; nRow++)
                rptds1.Tables["BOXNO"].ImportRow(dTable.Rows[nRow]);
