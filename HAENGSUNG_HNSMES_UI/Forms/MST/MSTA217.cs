...
namespace HAENGSUNG_HNSMES_UI.Forms.MST
{
    ...
    ///==========================================================
    ///</summary>
    public partial class MSTA217 : HAENGSUNG_HNSMES_UI.Forms.BASE.Form, HAENGSUNG_HNSMES_UI.Class.itfButton
    {
        // ******************************************* Base From Class ************************************
        ...
        private void MSTA217_Load(object sender, EventArgs e)
        {
        }

        private void MSTA217_Shown(object sender, EventArgs e)
        {
        ...
        public void SaveButton_Click()
        {
            ...
            string _strColor = "";
            string _strSQ = "";
            string _strWireLength = "";
            string _strFront = "";
            string _strFrontStrip = "";
            string _strRear = "";
            string _strRearStrip = "";
            string _strRemarks = "";
                ...
                foreach (DataRow _dr in _dt.Rows)
                {
                    switch (_dr.RowState)
                    {
                        case DataRowState.Modified:
                            ...
                            _strColor = _dr["COLOR"] + "";
                            _strSQ = _dr["SQ"] + "";
                            _strWireLength = _dr["WIRELENGTH"] + "";
                            _strFront = _dr["FRONT"] + "";
                            _strFrontStrip = _dr["FRONTSTRIP"] + "";
                            _strRear = _dr["REAR"] + "";
                            _strRearStrip = _dr["REARSTRIP"] + "";
                            _strRemarks = _dr["REMARKS"] + "";

                            if (!this.SaveData(_strItemcode, _strWire, _strColor, _strSQ, _strWireLength, _strFront,
                                _strFrontStrip,  _strRear, _strRearStrip, _strRemarks))
                            {
                                MainButton_INIT.PerformClick();
        ...
        private bool SaveData(string p_Itemcode, string p_Wire, string p_Color, string p_SQ, string p_WireLength,  string p_Front,
                              string p_FrontStrip, string p_Rear, string p_RearStrip, string p_strRemarks)
        {
            bool _blReturn = BASE_db.Execute_Proc("PKGBAS_BASE.PUT_CRIMPINGBASE"
                                                 , 1
                                                 , new string[] {
                                                   "A_CLIENT"
                                                 , "A_COMPANY"
