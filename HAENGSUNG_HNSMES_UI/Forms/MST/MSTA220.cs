...
{
    public partial class MSTA220 : HAENGSUNG_HNSMES_UI.Forms.BASE.Form, HAENGSUNG_HNSMES_UI.Class.itfButton
    {
        ...
        private void MSTA220_Load(object sender, EventArgs e)
        {
           
        }
        private void MSTA220_Shown(object sender, EventArgs e)
        {
        ...
        {
            bool _Rtn = BASE_db.Execute_Proc( "PKGBAS_BASE.SET_APPLICATOR"
                                            , 1
                                            , new string[] { 
                                              "A_CLIENT"
                                            , "A_COMPANY"
        ...
        private void GetGridViewList2()
        {
            BASE_DXGridHelper.Bind_Grid(gcList1
                                       , "PKGBAS_BASE.GET_APPLICATORDETAIL"
                                       , 1
                                       , new string[] {                                                      
                                         "A_CLIENT"
                                       , "A_COMPANY"
